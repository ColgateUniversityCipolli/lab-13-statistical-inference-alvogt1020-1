...
dat = tibble(
  further_vals = read_excel("lab13.fig2.data.xlsx", sheet = "g.Farther_vals")[[1]],
  closer_vals = read_excel("lab13.fig2.data.xlsx",sheet="g.Closer_vals")[[1]]
)
...
The mean and median for further values are -0.212 and -0.188, respectively. This indicates that singing further away decreases dopamine from its average levels.
...
The mean and median for closer values are 0.171 and 0.139, respectively. This indicates that singing closer away increases dopamine from its average levels.
...
The mean and median for the paired differences are 0.384 and 0.342, respectively. This indicates that, when birds sing closer to the adult song, their dopamine is higher than baseline.
